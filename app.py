...
from utils.feature_engineering import engineer_features_from_weather
...
def main() -> None:
    ...
    with m3:
        ...
        with st.container(border=True):
            ...
            st.write("**Number of features:** 4")
            st.write("**Expected input order:**")
            st.code("IRRADIATION, Hour, MODULE_TEMPERATURE, AMBIENT_TEMPERATURE", language="text")
            ...
            if model is not None and hasattr(model, "feature_importances_"):
                ...
                importance_df = pd.DataFrame(
                    {
                        "feature": ["IRRADIATION", "Hour", "MODULE_TEMPERATURE", "AMBIENT_TEMPERATURE"],
